...
import usePointerEvent from '../src/usePointerEvent'

describe('usePointerEvent (BT) integration', () => {
  it('binds mouse down and normalizes button/buttons', () => {
    const onPointerDown = vi.fn()
    const Comp = () => {
      const handlers = usePointerEvent({ onPointerDown })
      return (
        <view bindmousedown={handlers.handleMouseDown}></view>
      )
    }
  ...
  it('binds touch start and normalizes detail/touch fields', () => {
    ...
    const Comp = () => {
      const handlers = usePointerEvent({ onPointerDown })
      return (
        <view bindtouchstart={handlers.handleTouchStart}></view>
      )
    }
    const { container } = render(<Comp />)
...
describe('usePointerEvent (MT) integration', () => {
  it('binds MT mouse down and normalizes button/buttons/targets', async () => {
    let mtEventRef: ReturnType<typeof useMainThreadRef<any>> | null = null
    const Comp = () => {
      mtEventRef = useMainThreadRef<any>(null)
      const handlers = usePointerEvent({
        onPointerDownMT: (e) => {
          'main thread'
      ...
      return (
        <view main-thread:bindmousedown={handlers.handleMouseDownMT}></view>
      )
    }
    const { container } = render(<Comp />)
  ...
  it('binds MT touch start and normalizes detail/touch fields', async () => {
    ...
    const Comp = () => {
      ...
      return (
        <view main-thread:bindtouchstart={handlers.handleTouchStartMT}></view>
      )
    }
    const { container } = render(<Comp />)
